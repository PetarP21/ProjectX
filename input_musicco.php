...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="input_musicco.php" class="w3-bar-item w3-button w3-padding-large w3-white">Музикална компания</a>
  ...
  <div class="w3-content">
      ...
      <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO Muzikalna_kompaniya(Muzikalna_kompaniya) VALUES('$musicco')";

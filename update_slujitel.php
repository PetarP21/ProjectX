...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="update_slujitel.php" class="w3-bar-item w3-button w3-padding-large w3-white">Служител</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на служител за редактиране: <input type="text" name="idslujitel"><br>
    Име на служителя: <input type="text" name="name"><br>
    ID на позиция на служителя: <input type="text" name="idpoziciya"><br>
    Телефон на служителя: <input type="text" name="telefon"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $name=$_POST["name"];
            $idpoziciya = $_POST["idpoziciya"];
            $telefon = $_POST["telefon"];
            $sql ="UPDATE Slujitel set Ime_s='$name',Poziciya_id='$idpoziciya',Telefon_s='$telefon' where Slujitel_id='$idslujitel'";

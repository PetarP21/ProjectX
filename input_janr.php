...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="input_janr.php" class="w3-bar-item w3-button w3-padding-large w3-white">Жанр</a>
  ...
  <div class="w3-content">
      ...
      <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            $janr = $_POST["janr"];
            $sql = "INSERT INTO Janr(Janr) VALUES('$janr')";
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr><td>" . $row["Janr_id"] . "</td><td>" . $row["Janr"] . "</td></tr>";
        }
    }
    $conn->close();
    ?></p>

...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="update_slujitel_poziciya.php" class="w3-bar-item w3-button w3-padding-large w3-white">Позиция</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на позиция за редактиране: <input type="text" name="idpoziciya"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql ="UPDATE Slujitel_poziciya set Poziciya='$poziciya' where Poziciya_id='$idpoziciya'";
        ...
        $sql1 = "SELECT * FROM Slujitel_poziciya";

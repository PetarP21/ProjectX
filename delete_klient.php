...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="delete_klient.php" class="w3-bar-item w3-button w3-padding-large w3-white">Клиент</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на клиент за изтриване: <input type="text" name="idklient"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql ="DELETE FROM klient WHERE Client_id='$idklient'";

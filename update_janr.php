...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="update_janr.php" class="w3-bar-item w3-button w3-padding-large w3-white">Жанр</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на жанр за редактиране: <input type="text" name="idjanr"><br>
    Жанр: <input type="text" name="janr"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $janr=$_POST["janr"];
            $idjanr=$_POST["idjanr"];
            $sql ="UPDATE Janr set Janr='$janr' where Janr_id='$idjanr'";

...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="update_musicco.php" class="w3-bar-item w3-button w3-padding-large w3-white">Музикална компания</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на музикална компания за редактиране: <input type="text" name="idmusicco"><br>
    Музикална компания: <input type="text" name="musicco"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $musicco=$_POST["musicco"];
            $sql ="UPDATE Muzikalna_kompaniya set Muzikalna_kompaniya='$musicco' where Muzikalna_kompaniya_id='$idmusicco'";
        ...
        $sql1 = "SELECT * FROM Muzikalna_kompaniya";

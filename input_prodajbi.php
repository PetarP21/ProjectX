...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="input_prodajbi.php" class="w3-bar-item w3-button w3-padding-large w3-white">Продажби</a>
  ...
  <div class="w3-content">
      ...
      <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $data = $_POST["data"];
            $sql = "INSERT INTO Prodajbi(Client_id,Slujitel_id,Data_p) VALUES('$idklient','$idslujitel','$data')";

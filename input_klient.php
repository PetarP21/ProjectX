...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="input_klient.php" class="w3-bar-item w3-button w3-padding-large w3-white">Клиент</a>
  ...
  <div class="w3-content">
      ...
      <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO Klient(Ime_k,Adres_k,Telefon_k) VALUES('$name','$address','$telefon')";

...
<div class="w3-top">
  ...
  <h1 class="w3-margin w3-jumbo">Последните 5 продажби на стоки, издавани в последната година, подредени по служител</h1>
</header>
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <p class="w3-text-grey"><?php
        ...
        $sql = "SELECT SLUJITEL.IME_S,PRODAJBI.DATA_P,vid_st,godina_st,IZPALNITEL.IZPALNITEL,JANR.JANR,MUZIKALNA_KOMPANIYA.MUZIKALNA_KOMPANIYA from stoki 
        ...
        order by SLUJITEL.IME_S,DATA_P desc limit 5";
        ...
        <tr>
            <th class='w3-container w3-red w3-center'>Име на служител</th>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr><th>" . $row["IME_S"] . "</th><th>" . $row["DATA_P"] . "</th><th>" . $row["vid_st"] . "</th><th>" . $row["godina_st"] ."</th><th>" . $row["IZPALNITEL"] ."</th><th>" . $row["JANR"] ."</th><th>" . $row["MUZIKALNA_KOMPANIYA"] ."</th></tr>";
        }
    }
    $conn->close();
    ?></p>

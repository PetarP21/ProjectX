...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="update_klient.php" class="w3-bar-item w3-button w3-padding-large w3-white">Клиент</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    ID на клиент за редактиране: <input type="text" name="idklient"><br>
    Име на клиента: <input type="text" name="name"><br>
    Адрес на клиента: <input type="text" name="address"><br>
    Телефон на клиента: <input type="text" name="telefon"><br>
    ...
    <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql ="UPDATE Klient set Ime_k='$name',Adres_k='$address',Telefon_k='$telefon' where Client_id='$idklient'";

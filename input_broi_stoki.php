...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="input_broi_stoki.php" class="w3-bar-item w3-button w3-padding-large w3-white">Брой стоки</a>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
      ...
      <h5 class="w3-padding-32 w3-center"><form action="#" method="POST">
        ID на продажба: <input type="text" name="idprodajba"><br>
        ID на стока: <input type="text" name="idstoka"><br>
        Брой: <input type="text" name="broi"><br>
      ...
      <p class="w3-text-grey"><?php
        ...
        if (isset($_POST["submit"])) {
            ...
            $broi = $_POST["broi"];
            $sql = "INSERT INTO Broi_stoki(Prodajba_id,Stoka_id,broi_s) VALUES('$idprodajba','$idstoka','$broi')";
